...
| `ctrl-c1-init` | init | 0 | 4 | 8.0 | pending | pending | pending | pending | pending | pending |
| `ctrl-c2-wind2` | wind 2 | 2 | 4 | 8.0 | pending | pending | pending | pending | pending | pending |
| `ctrl-c3-wind6` | wind 6 | 6 | 4 | 8.0 | pending | pending | pending | pending | pending | pending |
| `ctrl-c3-wind8` | wind 8 | 8 | 4 | 8.0 | pending | pending | pending | pending | pending | pending |
