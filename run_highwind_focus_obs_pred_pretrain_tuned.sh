...
BASE_LOG_DIR="saves/descent_obs_pred_pretrain_highwind_focus_variable_wind_nclatent_tuned"
RUN_LOG="test_results/descent_obs_pred_pretrain_highwind_focus_variable_wind_nclatent_tuned_${STAMP}.log"
...
"${PY}" train_phase.py \
  ...
  --obs-predictor-lr 1e-4 \
  --obs-predictor-non-cable-weight 8.0 \
  --obs-predictor-cable-latent-weight 0.5 \
